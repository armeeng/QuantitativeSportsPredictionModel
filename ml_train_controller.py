...
def main():
    ...
    TRAIN_QUERY  = "SELECT * FROM games WHERE sport = 'NBA' AND DATE < '2024-12-10' ORDER BY date ASC;"
    TEST_QUERY   = "SELECT * FROM games WHERE sport = 'NBA' AND DATE > '2024-12-10' ORDER BY date ASC;"
